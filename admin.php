    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner" class="container">
                <center>
                    <h3>Selamat Datang di Content Mangement System <br> <b> Halim Perdanakusuma International Airport</b></h3>
                    <img src="uploads/10999-slide3.jpg" width="870px" style="margin-top: 20px">
                </center>
            </div>
            <!-- /. PAGE INNER  -->
        </div>
