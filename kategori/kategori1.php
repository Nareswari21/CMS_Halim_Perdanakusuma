...
<body>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="container" style="width: 90%; margin-top: 40px">
                    ...
                    <form action="../aksitampilkan/aksitampilkan1.php?logout" method="POST" > <br>
                    ...
                    <div class="row">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><img inlineblock src="<?php echo '../upload/uploads/'.$row['file_name'];?>" width="100px" height="60px" /></td>
                                    <td><?php echo $row['file_name'] ?></td>
                                    <td><a class="btn btn-danger" href="../delete/delete.php?op=delete&file_name=<?php echo $row['file_name']?>" role="button">Hapus</a></td>
                                </tr>
                                <?php
                                    }
                                ?>
    ...
    <!-- /. WRAPPER  -->
    <div id="footer-sec">
        &copy; 2020 Halim Perdana Kusuma International Airport</a>
    </div>
    <!-- /. FOOTER  -->
