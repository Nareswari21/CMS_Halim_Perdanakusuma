        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="container" style="width: 90%; margin-top: 40px">
                    <form action="../add/add10.php" method="POST" enctype="multipart/form-data">
                        <label>Upload Gambar</label>
                        <input type="file" name="file_name" class="form-control" id="exampleInputEmail1"> <br>
                        <button type="submit" name="submit" class="btn btn-primary">Upload</button>
                    </form> <br>
                    <form action="../aksitampilkan/aksitampilkan10.php?logout" method="POST" >
                ...
                <div class="container" style="width: 80%">
                    <div class="row">
                        <table class="table">
                            ...
                            <tbody>
                                <?php 
                                    $data="select * from tbl_images10";
                                    $result = mysqli_query($conn, $data);
                                    while($row = mysqli_fetch_array($result)) {
                                ?>
                                <tr>
                                    <td><video inlineblock src="<?php echo '../upload/uploads10/'.$row['file_name'];?>" width="100px" height="60px" ></video></td>
                                    <td><?php echo $row['file_name'] ?></td>
                                    <td><a class="btn btn-danger" href="../delete/delete10.php?op=delete&file_name=<?php echo $row['file_name']?>" role="button">Hapus</a></td>
                                </tr>
                                <?php
                                    }
                                ?>
